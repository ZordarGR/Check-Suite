...
(async()=>{
 ...
 try{
  ...
  await p.evaluate(()=>{
   ...
   window.__rcRateGrids=[{...rooms["101"],at:1,complete:true,nights:[{date:"25/09/26",room:"101",tax:true},{date:"26/09/26",room:"101",tax:false}]}];
   window.__tx.setRate(window.__fixtureRate);window.__tx.render();
  });
  ...
  await p.evaluate(()=>{window.__rcRateGrids[0].complete=false;window.__tx.setRate(window.__fixtureRate);window.__tx.render();});
