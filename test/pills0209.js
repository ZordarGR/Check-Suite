...
function run(localStorage, ROOMS, receipts, reportDate){
  ...
  const body = [elDecl, lift("dateNum"), lift("dShort"), lift("rKey"), lift("rState"),
    ...
    lift("checkableList"), lift("sameName"), lift("isCutOf"), lift("receiptFullName"), lift("receiptName"), lift("nameHit"), lift("censusNameOf"), lift("nameWordSet"), lift("nameLike"), lift("otherNames"), "let ARRIVING = {};",
