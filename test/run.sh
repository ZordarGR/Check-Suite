...
cd "$(dirname "$0")/.."
fail=0
for t in scopecheck movespanel pills0209 report poison names nighttest dst quiet stdout inhouse livenames roomsfile alerts reports moves helperline watchlog evflow; do
  printf '\n=== %s ===\n' "$t"
