...
try{ window.__t = { openModal:openModal, closeModal:closeModal,
  ...
  showScreen:showScreen, setDebug:setDebug, renderAccordions:renderAccordions,
  setModel:function(m){MODEL=m;}, setState:function(x){STATE=x;},
  getModel:function(){return MODEL;}, getState:function(){return STATE;},
  receiptFingerprint:receiptFingerprint, matchCard:matchCard,
