...
static bool cellFail, cellThrow, mutate, countChange;
...
static int HeaderAt(string[] s,string t){return -1;}
...
public string[] Headers(){return new string[]{"Name","Room"};}
public string Get(int r,int c,bool h){return GetText(r,c,h,true);}
public string GetText(int r,int c,bool h,bool wide){calls++;if(cellFail)ok=false;string x=Cell(r,c);return mutate&&calls>7&&c==0?"OTHER GUEST":x;}
public void Dispose(){}
}
${src.slice(a,b)}
static int bad=0;
